...
var player_x = oPlayer.x + handOffset[oPlayer.face];
var player_y = oPlayer.y - 18;
...
var restricted_radius = 10; // Change this value to whatever radius you want
var max_distance = 40
...
if(oPlayer.face > 0 && oPlayer.face < 4)
{
